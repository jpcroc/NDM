...
class QMainWindowIra(QMainWindowForRibbon):
  """
  QMainWindow with ribbonWidget for iradina
  """

  index = [0]  # for unique instance naming, if some

  def __init__(self, *args, **kwargs):
    super(QMainWindowIra, self).__init__(*args)
    self.setObjectName("QMainWindowIra%s" % str(self.index))
    self.setWindowTitle("IRADINA GUI") # default
  ...
  def setFromJson(self, valuesJson=None):
    ...
    values not used, yet
    """
    RT.trace("QMainWindowForIradina.setFromJson: create widget")
    self.__addCentral()
  ...
  def close(self):
    ...
    print "QMainWindowForIradina %s close",self.objectName()
    return super(QMainWindowForIradina, self).close()

  def closeEvent(self, event):
    print "QMainWindowForIradina %s closeEvent",self.objectName()
    #event.ignore()
    return super(QMainWindowForIradina, self).closeEvent(event)

  def event(self, event):
    print "QMainWindowForIradina %s event",self.objectName(),strEvent(event)
    return super(QMainWindowForIradina, self).event(event)

  def __del__(self):
    print "QMainWindowForIradina %s __del__",self.objectName()
    return super(QMainWindowForIradina, self).__del__()
  """
  ...
  def __addCentral(self, valuesJson=None):
    ...
    values not used, yet
    """
    RT.trace("QMainWindowForIradina.__addCentral: create centralWidget QTabMultipleText")
  ...
  def __addDocks(self, valuesJson=None):
    ...
    values not used, yet
    """
    RT.trace("QMainWindowForIradina.__addDocks: For example only")
    self.docks = []
  ...
  def __addRibbonDock(self, valuesJson=None):
    ...
    values not used, yet
    """
    RT.trace("QMainWindowForIradina.__addRibbonDock: create Ribbon in dock")
  ...
  def __addRibbonToolBar(self, valuesJson=None):
    ...
    values not used, yet
    """
    RT.trace("QMainWindowForIradina.__addRibbonToolBar: create Ribbon in ToolBar")
    import ribbonpy.ribbonClassFactory as RCF
  ...
  def __addToolBars(self, valuesJson=None):
    ...
    values not used, yet
    """
    RT.trace("QMainWindowForIradina.__addToolBars: not yet implemented")
    return
    self.toolBars = []
  ...
  def __createActions(self, valuesJson=None):
    ...
    RT.trace("QMainWindowForIradina.__createActions: not yet implemented")
    return
    self.actions = []
