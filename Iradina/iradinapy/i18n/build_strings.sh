...
echo "Build strings for French, create and merging iradinaGUI.po"

poFile=$I18HOME/fr/LC_MESSAGES/iradinaGUI.po
...
echo "Do not forget 'translate.py' or 'translate.sh' to create iradinaGUI.mo"
