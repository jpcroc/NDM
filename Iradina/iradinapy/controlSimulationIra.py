...
>>> more $URANIESYS/include/UVersion.h
    #ifndef URANIE_UVersion
    #define URANIE_UVersion
     ...
     *
     *    #if URANIE_VERSION_CODE >= URANIE_VERSION(0,4,1)
     *       #include <newheader.h>
     *    #else
     *       #include <oldheader.h>
     *    #endif
    ...
    */
    ...
    #define URANIE_RELEASE "3.6/0"
    #define URANIE_RELEASE_MAJOR 3
    #define URANIE_RELEASE_MINOR 6
    #define URANIE_RELEASE_PATCH 0
    #define URANIE_RELEASE_DATE "Wed Dec 17, 2014"
    #define URANIE_RELEASE_TIME "19:34:44"
    #define URANIE_VERSION_CODE 198144
    #define URANIE_VERSION(a,b,c) (((a) << 16) + ((b) << 8) + (c))

    #endif
"""

###############################################################
class UserModeIra(IFLX.StrInListXyz):

  _allowedList = CFGIRA.getExistingModes()
...
########################################################################################
class ControlSimulationIra(_XyzConstrainBase):
  """
  ...
  _attributesList = [ #list, not a dict because sequential order list is used in files
    ...
    # TODO synchronize with ModelIra.userMode(self)  ("userMode", "UserModeIra"),
  ...
  _helpDict = {
    ...
    "userMode": (u"user mode of iradina input data display", ""),
    #TODO? "settings": (u"Settings from uranieGui.ini", ""),
  }
  
  def __init__(self):
    super(ControlSimulationIra, self).__init__()
    self._defautNameAsRoot = "Controls"
    self.setIsCast(True)
    self._setAllAttributesList()

  def setDefaultValues(self):
    super(ControlSimulationIra, self).setDefaultValues()
...
CLFX.appendAllXyzClasses( [UserModeIra, ControlSimulationIra] )
