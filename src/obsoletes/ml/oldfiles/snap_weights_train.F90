...
module snap_weights_trains_mod
        !use snap ! , only :dim_weights_function 
        implicit none
        contains
!$-------------------------------------------------------------
...
!  use snap, only : tmp_weights, weights_snap, dim_weights_function, dim_weights_function_full,train_snap_get_parameters
!  !use snap
!  implicit none
