...
contains
    subroutine test_performances
        ...
        call file_write%init_fortran("test_for.txt", "w")
        ...
        call file_read%init_fortran("test_for.txt", "r")
        call system_clock(start_time, count_rate)
        do i=1, lines_count
    ...
    subroutine test_append
        ...
        call file%init_fortran("append.txt", "w", stat=stat)
...
write(*,*)
        call file%init_fortran("append.txt", "a", stat=stat)
        ...
        call check(stat==0, "closing file", stat%string())
write(*,*)
        call file%init_fortran("append.txt", "r", stat=stat)
