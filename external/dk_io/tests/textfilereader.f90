...
contains
    subroutine test_performances
        ...
        call start_test_group("uncompressed writing")
        call system_clock(start_time, count_rate)
        call file_write%init("test.txt", "w")
        do i=1, lines_count
        ...
        call start_test_group("uncompressed reading")
        call system_clock(start_time, count_rate)
        call file_read%init("test.txt", "r")
        do i=1, lines_count
    ...
    subroutine test_append
        ...
        call file%init("append.txt", "w", stat=stat)
        ...
        call file%init("append.txt", "a", stat=stat)
        ...
        call file%init("append.txt", "r", stat=stat)
...
!------
        ...
        call check(stat=="No such file or directory", "opening non-existing file for reading")
        call stat%discard

        call reader%open_file("invalid/newfile.txt", "write", stat)
        call check(stat=="No such file or directory", "opening non-existing file for writing")
        call stat%discard
