...
class page :
	def __init__(self,ip) :
		...
		self.sals=[]
class Ancien: 
	def __init__(self,badge,com1,com2,com3) :
...
for iline in range(len(comligne)):
	...
	try :
		...
		anclist.append(Ancien(badge,com1,com2,com3))
	except:
		pass
...
for ipg	in range(len(ldpg)):
	...
	with open(nf) as file:
		...
		for salcur in pagecur.sals:
			...
			fileo.write(f"{salcur.badge} ; {salcur.nom}; {salcur.genre}; {salcur.age}; {salcur.cat}; {salcur.ech}; {salcur.classement}; {salcur.affect}; {salcur.diplome}; {salcur.embauche};{salcur.clembauche} ; {salcur.av[0]}; {salcur.av[1]}; {salcur.av[2]}; {salcur.av[3]}; {salcur.av[4]}; {salcur.av[5]}; {salcur.av[6]}; {salcur.av[7]}; {salcur.av[8]}; {salcur.av[9]}; {salcur.com1}; {salcur.com2}; {salcur.com3} \n")
			print("bingo")
			# exit()
			# else :
