	...
	def check(self,testA,remp):
		...
		if not hasattr(self,testA):
			...
			if testA=='nom' :
				...
				enlv2(self,Pages[ipg].text,tranchepb)

				# enleveposte(self,Pages[ipg].text,'CHEF DE BRIGADE',tranchepb)
				# enleveposte(self,Pages[ipg].text,'AGENT SECURITE',tranchepb)
				# enleveposte(self,Pages[ipg].text,'GESTIONNAIRE',tranchepb)
				# enleveposte(self,Pages[ipg].text,'INGENIEUR',tranchepb)
				# enleveposte(self,Pages[ipg].text,'AGENT DE SECURITE',tranchepb)
				# enleveposte(self,Pages[ipg].text,'RESPONSABLE',tranchepb)
				# enleveposte(self,Pages[ipg].text,'TECHNICIEN',tranchepb)
				# enleveposte(self,Pages[ipg].text,"CHEF GRP D'AGENTS",tranchepb)
				# enleveposte(self,Pages[ipg].text,'SECRETAIRE',tranchepb)
				# enleveposte(self,Pages[ipg].text,'INFIRMIER CONFIRME',tranchepb)
				# enleveposte(self,Pages[ipg].text,'INFIRMIER PRINCIPAL',tranchepb)
				# enleveposte(self,Pages[ipg].text,'ASS. SERV.SOCIAL',tranchepb)
				# enleveposte(self,Pages[ipg].text,'ASS. SERV.SOCIAL',tranchepb)
				...
				# for textc in Pages[ipg].text :
					# if textc.col==0 and textc.tranche==tranchepb: 
						# if textc.x==35. and 'SECRETAIRE' in textc.text:
							# self.nom=textc.text.replace('SECRETAIRE','')
							# self.comp=True
							# self.lok=True
				# for textc in Pages[ipg].text :
					# if textc.col==0 and textc.tranche==tranchepb: 
						# if textc.x==35. and "CHEF GRP D'AGENTS" in textc.text:
							# self.nom=textc.text
							# self.comp=True
							# self.lok=True
				# for textc in Pages[ipg].text :
					# if textc.col==0 and textc.tranche==tranchepb: 
						# if textc.x==35. and 'AGENT SECURITE' in textc.text:
							# self.nom=textc.text.replace('AGENT SECURITE','')
							# self.comp=True
							# self.lok=True
				# for textc in Pages[ipg].text :
					# if textc.col==0 and textc.tranche==tranchepb: 
						# if textc.x==35. and 'GESTIONNAIRE' in textc.text:
							# self.nom=textc.text.replace('GESTIONNAIRE','')
							# self.comp=True
							# self.lok=True
				if not self.lok	:
					print( testA, self.badge)
					exit()
			if testA=='affect' :
				self.affect=remp
				self.comp=True
...
def enleveposte (sal,text,poste,tranchepb) :
	for textc in text :
		# print(textc.text)
		if textc.col==0 and textc.tranche==tranchepb: 
			if textc.x==35. and poste in textc.text:
				# print("BBIIIIIP",textc)
				sal.nom=textc.text.replace(poste,'')
				sal.comp=True
				sal.lok=True

def enlv2 (sal,text,tranchepb) :
	for textc in text :
		# print(textc.text)
		if textc.col==0 and textc.tranche==tranchepb: 
			if textc.x==35. :
				print(textc.text.split()[2:])
				nml=textc.text.split()[:2]
				sal.nom=" ".join(nml)
				sal.comp=True
				sal.lok=True
