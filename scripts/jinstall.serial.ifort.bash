...
export NDM_BUIDIR=${NDM_ROODIR}/ndm_build_ifort
export NDM_INSDIR=${NDM_ROODIR}/ndm_install_ifort
...
###### IFORT serial
cmake -C ${NDM_SRCDIR}/cmake_files/ndm_preset_ifort_serial.cmake -S ${NDM_SRCDIR}
