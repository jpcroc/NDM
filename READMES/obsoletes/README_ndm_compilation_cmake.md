...
export NDM_SRCDIR=${NDM_ROODIR}/NDM
export NDM_BUIDIR=${NDM_ROODIR}/ndm_build_gnu_mpi
export NDM_INSDIR=${NDM_ROODIR}/ndm_install_gnu_mpi
envs -p NDM_

cd ${NDM_ROODIR} ; rm -rf ${NDM_BUIDIR} ; rm -rf ${NDM_INSDIR} ; mkdir ${NDM_BUIDIR} ; cd ${NDM_BUIDIR}

cmake -C ${NDM_SRCDIR}/cmake_files/ndm_preset_gnu_parallel.cmake ${NDM_SRCDIR}
