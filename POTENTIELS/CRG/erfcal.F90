...
subroutine calerf(arg, result, jint)
  ...
  !-----------------------------------------------
  integer :: i
  real(double), dimension(5) :: a
  real(double), dimension(4) :: b
  real(double), dimension(9) :: c
  real(double), dimension(8) :: d
  real(double) :: del, four, half
  real(double), dimension(6) :: p
  real(double) :: one
  real(double), dimension(5) :: q
  real(double) :: sixten, sqrpi, two, thresh, x, xbig, xden, xhuge, xinf, &
       xmax, xneg, xnum, xsmall, y, ysq, zero
  !-----------------------------------------------
  !------------------------------------------------------------------
  !
  ...
  data xbig, xhuge, xmax/ 26.543D0, 6.71D7, 2.53D307/
  !------------------------------------------------------------------
  ...
  data a/ 3.16112374387056560D00, 1.13864154151050156D02, &
       3.77485237685302021D02, 3.20937758913846947D03, 1.85777706184603153D-1&
       /
  ...
  data c/ 5.64188496988670089D-1, 8.88314979438837594D0, &
       6.61191906371416295D01, 2.98635138197400131D02, 8.81952221241769090D02&
       , 1.71204761263407058D03, 2.05107837782607147D03, &
       1.23033935479799725D03, 2.15311535474403846D-8/
  data d/ 1.57449261107098347D01, 1.17693950891312499D02, &
       5.37181101862009858D02, 1.62138957456669019D03, 3.29079923573345963D03&
       , 4.36261909014324716D03, 3.43936767414372164D03, &
  ...
  data p/ 3.05326634961232344D-1, 3.60344899949804439D-1, &
       1.25781726111229246D-1, 1.60837851487422766D-2, 6.58749161529837803D-4&
       , 1.63153871373020978D-2/
  data q/ 2.56852019228982242D00, 1.87295284992346047D00, &
       5.27905102951428412D-1, 6.05183413124413191D-2, 2.33520497626869185D-3&
       /
  !------------------------------------------------------------------
  x = arg
  y = abs(x)
...
!---------- Last card of DERFC ----------
      ...
      real(kind(0.0d0)) function derfcx (x)
