...
!     write(6,*)xp(i),potp(i)
  ...
  roff2=roff2*1d-8
  stp=stp*1d-8
  call zieg2(potz, potz_d, stp,npt, catom, roff1, roff2,potzt,potzt2)
  potz=potz*erg2ev
  potzt=potzt*erg2ev
  potzt2=potzt2*erg2ev

  do i=1,npt
     write(12,*)xp(i),potz(1,i)
     write(14,*)xp(i),potzt(i)
     write(15,*)xp(i),potzt2(i)
!     write(6,*)xp(i),potz(1,i)
  end do
