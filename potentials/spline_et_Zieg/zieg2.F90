...
subroutine zieg2(pot, pot_d, csive,ngrid, catom, roff1, roff2,potzt,potzt2,ndec)
  !-----------------------------------------------
  !   M o d u l e s
  !-----------------------------------------------
  ...
  interface
subroutine zieg(zie,decal,catom,roff1,roff2,auxe,  pot,ngrid,csive,ndec)
...
!csive=csive*1e-8
call zieg(zie,decal,catom,roff1,roff2,auxe,  pot,ngrid,csive,ndec)
