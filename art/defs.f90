...
!  integer :: MAXNEI             ! Maximum number of nearest neighbours
  ...
  real(8), dimension(:), allocatable :: initial_direction,selected_atoms  ! Initial move for leaving harmonic  well
  character(len=5), dimension(:), allocatable :: Atom
  integer, dimension(2)  :: count_saddle 
