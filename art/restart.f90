...
subroutine restart_states(istatus,ieventcurrent, iterations)
  ...
  read(FRESTART,*) box(1),box(2),box(3), scala, boxref(1),boxref(2),boxref(3), scalaref
...
subroutine save_state(istatus,iter,direction)
  ...
  write(FRESTART,*)box(1),box(2),box(3), scala, boxref(1),boxref(2),boxref(3), scalaref
