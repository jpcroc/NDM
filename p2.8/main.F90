...
program ndm
 ...
 PRINT *, 'Process ', myid, ' of ', nprocs, ' is alive'
  ...
  if (rang==0) write(6,*)'*** NDM868 ***'
#if(ART)
  if (rang==0) write(6,*)'*** NDM868+ ART ***'
#endif

#if(PHONDY)
  if (rang==0) write(6,*)'*** NDMP868 +  PHONDY ***'
#endif
...
#if(MAB)
  rangmab=0
  if (rang==0) write(6,*)'*** NDMP868 +   MAB ***'
#if (ML && PARAML)
  if (rang==0) write(6,*)'*** NDMP868 +   MAB + ML + PARAML ***'
  call init_mpi_mab()
  rang=rangmab
#endif
#if(LAMMPS_VERSION)
