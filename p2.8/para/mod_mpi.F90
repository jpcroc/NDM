...
contains
  ...
  subroutine envoi_atomes_fantomes
    ...
    call MPI_ALLREDUCE(nb_at_max,nb_at_max_tot,1,MPI_INTEGER,MPI_MAX,MPI_COMM_WORLD,ierr)
...
!    nb_var_dbl = 15
  ...
  if ((llangevin.eqv..true.).or.(l2T.eqv..true.))then
    ...
    do nproc_voisin= 1, nbr_proc_voisin
       procv = proc_voisin(nproc_voisin)
       call MPI_IRECV(recv_nb_val(nproc_voisin), 1, MPI_INTEGER, procv, 1001, MPI_COMM_WORLD, recv_rqst(nproc_voisin,1), ierr)
       call MPI_IRECV(recv_buff_int(1,1,nproc_voisin), nb_var_int*nb_at_max, MPI_INTEGER, procv, 1002, &
            MPI_COMM_WORLD, recv_rqst(nproc_voisin,2), ierr)
       call MPI_IRECV(recv_buff_dbl(1,1,nproc_voisin), nb_var_dbl*nb_at_max, NDM_MPI_REAL_DOUBLE, procv, 1003, &
            MPI_COMM_WORLD, recv_rqst(nproc_voisin,3), ierr)
    enddo
...
!    nb_var_dbl = 15
   if  (lsuivinonpbc) then
    ...
    do nproc_voisin = 1, nbr_proc_voisin
       procv = proc_voisin(nproc_voisin)
       call MPI_IRECV(recv_nb_val(nproc_voisin), 1, MPI_INTEGER, procv, 2001, MPI_COMM_WORLD, recv_rqst(nproc_voisin,1), ierr)
...
!             send_buff_dbl(15,send_nb_val(nproc_voisin),nproc_voisin) = fp(3,i_at)
       ...
       call MPI_ISEND(send_nb_val(nproc_voisin),      1,   MPI_INTEGER,        &
            procv,2001,MPI_COMM_WORLD,send_rqst(nproc_voisin,1),ierr)

       call MPI_ISEND(send_buff_int(1,1,nproc_voisin),nb_var_int*nb_at_max,MPI_INTEGER,        &
            procv,2002,MPI_COMM_WORLD,send_rqst(nproc_voisin,2),ierr)

       call MPI_ISEND(send_buff_dbl(1,1,nproc_voisin),nb_var_dbl*nb_at_max,NDM_MPI_REAL_DOUBLE,&
            procv,2003,MPI_COMM_WORLD,send_rqst(nproc_voisin,3),ierr)
...
!          fp(3,pt_at_ftm) = recv_buff_dbl(15,i_at,ind_recv)
  ...
  subroutine envoi_tabdensity_frontieres(tabdensity)
    ...
    do nproc_voisin = 1, nbr_proc_voisin
       procv = proc_voisin(nproc_voisin)
       call MPI_IRECV(recv_nb_val(nproc_voisin), 1, MPI_INTEGER, procv, 3001, MPI_COMM_WORLD, recv_rqst(nproc_voisin,1), ierr)
    ...
    do nproc_voisin = 1, nbr_proc_voisin
       ...
       ! On envoit les buffers vers le processeur
       call MPI_ISEND(send_nb_val(nproc_voisin),      1,   MPI_INTEGER,        &
            procv,3001,MPI_COMM_WORLD,send_rqst(nproc_voisin,1),ierr)

       call MPI_ISEND(send_buff_int(1,1,nproc_voisin),nb_at_max,MPI_INTEGER,        &
            procv,3002,MPI_COMM_WORLD,send_rqst(nproc_voisin,2),ierr)

       call MPI_ISEND(send_buff_dbl(1,1,nproc_voisin),nb_at_max,NDM_MPI_REAL_DOUBLE,&
            procv,3003,MPI_COMM_WORLD,send_rqst(nproc_voisin,3),ierr)
  ...
  subroutine envoi_fp_fantomes
    ...
    do nproc_voisin = 1, nbr_proc_voisin
       procv = proc_voisin(nproc_voisin)
       call MPI_IRECV(recv_nb_val(nproc_voisin), 1, MPI_INTEGER, procv, 4001, MPI_COMM_WORLD, recv_rqst(nproc_voisin,1), ierr)
    ...
    do nproc_voisin = 1, nbr_proc_voisin
       ...
       ! On envoit les buffers vers le processeur
       call MPI_ISEND(send_nb_val(nproc_voisin),      1,   MPI_INTEGER,        &
            procv,4001,MPI_COMM_WORLD,send_rqst(nproc_voisin,1),ierr)

       call MPI_ISEND(send_buff_int(1,1,nproc_voisin),nb_at_max,MPI_INTEGER,        &
            procv,4002,MPI_COMM_WORLD,send_rqst(nproc_voisin,2),ierr)

       call MPI_ISEND(send_buff_dbl(1,1,nproc_voisin),nb_at_max*3,NDM_MPI_REAL_DOUBLE,&
            procv,4003,MPI_COMM_WORLD,send_rqst(nproc_voisin,3),ierr)
