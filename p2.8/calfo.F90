module calfo_mod
  ...
  USE gen_com_m, ONLY:ibound,im_glob,lcontr,ldecal_bc,ldesinteg,lfrozen,lsigtyp,ltabvois,&
       &ltberendsen,ltranche,parallele,potis0,potis2,potisp,sigkine,sigtot,sigtyp,sigtyptyp,frozen
