!----------------------------------------------------------------------
SUBROUTINE calfoeamtabvois_ph(ia_s,ia_f,xp, vp,  fp,  ielat, iwmax, ityp)
...
!  potist = zero
  ...
  loop1at1: do i=1,im
     ...
     iw2 = iwmax(i)
        ...
        !deubg write(*,*) 'HERE IAM i,iw1,iw2', i,iw1,iw2
...
!  write(6,*)'eamtabvois'
  return
end SUBROUTINE calfoeamtabvois_ph
