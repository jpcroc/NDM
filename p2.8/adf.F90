module adf_mod
  ...
  USE gen_com_m, ONLY:cont888,iteration,linstantfda,nfda,pi,rang,thetamax,thetamin,timel
...
contains
  subroutine adf
    ...
    incre = (thetamax-thetamin)/cont888
    invincre = 1/incre
    ...
    if(.not.linstantfda) then
       do i3=1,ntyp
          ...
          do i1=1,ntyp
             ...
             do i2=i3,ntyp
                ...
                do m1=int(thetamin*invincre),cont888
                   m2 = m1+1
                   rspace2 = (m2*incre)**2
       ...
       if (rang==0) then
          write(6,*) ' sauvegarde fda iteration=',iteration
          write(6,*)
       end if
       do i3=1,ntyp
          do i1=1,ntyp
