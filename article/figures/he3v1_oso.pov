...
//
// This script was generated on jeu., 3 déc. 2015 11:13:03 +0100
// ******************************************************
...
function _setFileState() {
  ...
  load append /*file*/"./he3v1_oso"; set appendNew true;
  set allowEmbeddedScripts false;
  set appendNew true;
  set appletProxy "";
  set applySymmetryToBonds false;
...
function _setDefinedState() {
  ...
  connect  ({10}) ({4}) delete;;
  connect  ({10}) ({6}) delete;;
  connect  ({12}) ({20}) delete;;
  connect  ({12}) ({22}) delete;;
  connect  ({13}) ({20}) delete;;
  connect  ({13}) ({21}) delete;;
  connect  ({14}) ({20}) delete;;
  connect  ({14}) ({22}) delete;;
  connect  ({15}) ({20}) delete;;
  connect  ({15}) ({21}) delete;;
  connect  ({21}) ({16}) delete;;
  connect  ({21}) ({17}) delete;;
  connect  ({21}) ({18}) delete;;
  connect  ({21}) ({19}) delete;;
  connect  ({22}) ({16}) delete;;
  connect  ({22}) ({18}) delete;;
  connect  ({0}) ({11}) delete;;
  connect  ({1}) ({11}) delete;;
  connect  ({2}) ({11}) delete;;
  connect  ({3}) ({11}) delete;;
  connect  ({8}) ({11}) delete;;
  connect  ({11}) ({10}) delete;;
  connect  ({11}) ({4}) delete;;
  connect  ({11}) ({5}) delete;;
  connect  ({11}) ({9}) delete;;
  connect  ({11}) ({6}) delete;;
  connect  ({11}) ({7}) delete;;
  connect  ({12}) ({23}) delete;;
  connect  ({13}) ({23}) delete;;
  connect  ({14}) ({23}) delete;;
  connect  ({15}) ({23}) delete;;
  connect  ({20}) ({23}) delete;;
  connect  ({23}) ({22}) delete;;
  connect  ({23}) ({16}) delete;;
  connect  ({23}) ({17}) delete;;
  connect  ({23}) ({21}) delete;;
  connect  ({23}) ({18}) delete;;
  connect  ({23}) ({19}) delete;;
...
function _setModelState() {
  ...
  select ({8:10 20:22});
  Spacefill 0.2;
  select BONDS ({12:14 27:29});
  wireframe 0.08;
  select BONDS ({0:11 15:26});
  wireframe 0.1;
...
a(284.0,413.0,2982.0,25.0,0.65234375,0.65234375,0.671875,0)
a(289.0,143.0,2938.0,25.0,0.65234375,0.65234375,0.671875,0)
a(357.0,365.0,3259.0,25.0,0.65234375,0.65234375,0.671875,0)
a(360.0,97.0,3207.0,25.0,0.65234375,0.65234375,0.671875,0)
a(549.0,420.0,2918.0,25.0,0.65234375,0.65234375,0.671875,0)
a(541.0,165.0,2885.0,25.0,0.65234375,0.65234375,0.671875,0)
a(620.0,374.0,3186.0,25.0,0.65234375,0.65234375,0.671875,0)
a(607.0,121.0,3137.0,25.0,0.65234375,0.65234375,0.671875,0)
a(355.0,248.0,3087.0,16.5,0.8515625,1.0,1.0,0)
a(499.0,216.0,3043.0,16.5,0.8515625,1.0,1.0,0)
a(460.0,360.0,3078.0,16.5,0.8515625,1.0,1.0,0)
a(439.0,274.0,3069.0,33.5,1.0,1.0,0.19140625,0)
b(460.0,360.0,3078.0,6.724151,499.0,216.0,3043.0,6.724151,0.8515625,1.0,1.0,0)
a(460.0,360.0,3078.0,6.724151,0.8515625,1.0,1.0,0)
a(499.0,216.0,3043.0,6.724151,0.8515625,1.0,1.0,0)
b(355.0,248.0,3087.0,6.724151,499.0,216.0,3043.0,6.724151,0.8515625,1.0,1.0,0)
a(355.0,248.0,3087.0,6.724151,0.8515625,1.0,1.0,0)
a(499.0,216.0,3043.0,6.724151,0.8515625,1.0,1.0,0)
b(355.0,248.0,3087.0,6.724151,460.0,360.0,3078.0,6.724151,0.8515625,1.0,1.0,0)
