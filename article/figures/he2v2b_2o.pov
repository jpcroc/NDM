...
//
// This script was generated on jeu., 3 déc. 2015 10:55:51 +0100
// ******************************************************
...
function _setFileState() {
  ...
  load append /*file*/"./he2v2b_2o"; set appendNew true;
...
function _setDefinedState() {
  ...
  connect  ({13}) ({5}) delete;;
  connect  ({13}) ({7}) delete;;
  connect  ({12}) ({15}) delete;;
  connect  ({13}) ({14}) delete;;
  connect  ({13}) ({12}) delete;;
  connect  ({14}) ({12}) delete;;
  connect  ({0}) ({14}) delete;;
  connect  ({1}) ({14}) delete;;
  connect  ({2}) ({14}) delete;;
  connect  ({3}) ({14}) delete;;
...
a(330.0,137.0,3080.0,16.5,0.8515625,1.0,1.0,0)
