...
so He$_1V_2$ clusters can migrate via three ways with the same probability.\\
...
On Fig.\ref{fig:ed} the dissociation energy of He and vacancy with most stable He$_nV_m$ cluster as a function 
...
\end{tabular}
\caption{Dissociation energy of He and vacancy to He$_nV_m$ as a function of \textit{n/m} ratio 
...
\begin{itemize}
 ...
 He$_nV_1$ cluster is less than pure interstitial He$_n$ cluster for $n\ge3$ in V and $n\ge2$ in Ta.
