...
\begin{figure}
 \begin{tabular}{ccc}
    ...
    (a) & (b) & (c) \\
 \end{tabular}
 \caption{Di-vacancy migration along $V_{2}^{2nn}$ $\rightarrow$ $V_{2}^{2nn}$ path in Vanadium.
...
\begin{figure}
 \begin{tabular}{ccccc}
    ...
    (a) & (b) & (c) & (d) & (e) \\
 \end{tabular}
 \caption{Migration of He$_1V_1$ cluster in Vanadium.
...
\begin{figure}
 \begin{tabular}{ccccc}
    ...
    (a) & (b) & (c) & (d) & (e) \\
 \end{tabular}
 \caption{Migration of He$_1V_2$ cluster in Vanadium.
Vacancy, V and He atom are represented with yellow cube, grey and light blue ball respectively.
...
Similar to V the last mechanism is more energetically favorable (with $E^m$=0.55 eV) than the migration of the mono-vacancy.
...
\begin{figure}
 \begin{tabular}{ccccc}
    ...
    (a) & (b) & (c) & (d) & (e) \\
 \end{tabular}
 \caption{Migration of He$_1V_1$ cluster in Tantalum.
...
%  in substitutional sites because of larger density of state \MCM{DOS of what?} at Fermi level for V than for Ta.
 ...
 \item in the presence of He atom, diffusion of both mono-vacancy and di-vacancy involves dissociation of He atom from the 
