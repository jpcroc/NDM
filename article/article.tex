...
$V_2^{1nn}$ and  $V_2^{2nn}$ in variance with the di-vacancy energy landscape of $VIB$ metals, such as Mo and W \cite{Huang2016121}, 
...
and Au \cite{thomas1981}. This idea is supported by the lower formation energy for He$_{n}$V$_1$ clusters
...
We computed 2 paths for interstitial diffusion barrier : T site to T site (1nn), and T site to O site (1nn).
...
\\ There is an asymmetry in the di-vacancy migration barrier since we have from the 1nn configuration to 2nn configuration 
E$^m_{V_2}$ = 0.34 eV while reversed path gives E$^m_{V_2}$ = 0.58 eV. 
Then di-vacancy cluster migrates following 2nn $\rightarrow$ 2nn easier path  
with a barrier of E$^m_{V_2}$ = 0.37 eV and a 2 steps vacancy dissociation and recombination.
...
showed first the dissociation of He to the monovacancy. Then He atom diffuses to a position near tetrahedral interstitial, 
...
in the presence or not of He atoms in bcc Vanadium and Tantalum.
In summary, we present our main results :
\begin{itemize}
 \item Interstitial He atoms diffuse through tetrahedral sites in both V and Ta.
 
 \item Formation of Frenkel pair is expected with growing interstitial He$_n$ clusters, since the formation energy of 
 He$_n$V$_1$ cluster is less than pure interstitial He$_n$ cluster for $n\ge3$ in V and $n\ge2$ in Ta.
 
 \item In V, He atoms prefer to occupy interstitial sites contrary to Ta case for which He atoms reside in 
 substitutional sites because of larger density of state at Fermi level for V than for Ta.
 
 \item Like group $VI$ metals such as Mo and W, the formation of di-vacancy in 2nn configuration requires less energy than the
 1nn configuration for both V and Ta. The di-vacancies in V and Ta have a weak attractive interaction whereas 
 they are repulsive for group $VI$ metals.
 
 \item The effect of He on di-vacancies is to increase the formation energy of the 2nn configuration much more than the 1nn one 
 so that the hierarchy is reversed for $n\ge2$ in V and $n\ge1$ in Ta. In addition, He atom makes the 1nn configuration more 
 stable than the 2nn configuration as the binding energy of He$_n$V$_2^{1nn}$ to He atom and mono-vacancy is larger than 
 for He$_n$V$_2^{2nn}$ clusters.
 
 \item Generally speaking, He atom stabilizes vacancy type clusters and vice versa.
 
 \item For the 2 studied group $V$ metals, di-vacancy is more mobile than mono-vacancy. 
 The presence of He atom enhances migration energy barrier of both mono-vacancy and di-vacancy but also 
 their relative difference.
 
 \item In absence of He, the diffusion of di-vacancy exhibits an asymmetry in migration energy since 
 the 1nn $\rightarrow$ 2nn path has a lower barrier than the 2nn $\rightarrow$ 1nn path for V and Ta.
 ...
 For the di-vacancy diffusion in V, the 2nn $\rightarrow$ 2nn path is still favored, but in case of Ta, 
