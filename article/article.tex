...
mechanisms we have used Density Functional Theory. The presence of Hellium drastically impact the formation and the mobility of 
defect clusters.  
%
The results of calculations are systematized and can be easily used as input paramterers 
for multi-scale techniques including kinetic Monte Carlo simulations or cluster dynamics.
\end{abstract}
...
%
The hierachy in the energy of He interstitial configurations for for V and Ta,
the $T$ interstitial site is more stable than the $O$ site, is similar to others bcc 
...
the He binding energy seems to decrease with \textit{n}, especially for $V_3$ (Fig.\ref{fig:eb_he})
...
has a lower barrier with 0.66 eV. The latter process is a two step mechanism. 
