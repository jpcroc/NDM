...
One the vacancy dissociates from the $V_2^{2nn}$ cluster to reach its 1st nearest neighbour position 
...
recombines with the first vacancy to form again the $V_2^{2nn}$ cluster.}
...
Similar to V the last mechanism is more favorable (with $E^m$=0.55 eV) than the migration of the mono-vacancy.
...
\wes{Finally, He recombines with the mono-vacancy at $S$ site. This corresponds to the 'impeded interstitial mechanism' or 
