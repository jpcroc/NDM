...
\begin{figure}
 \begin{tabular}{ccc}
    ...
    (a) & (b) & (c) \\
 \end{tabular}
 \caption{Di-vacancy migration along $V_{2}^{2nn}$ $\rightarrow$ $V_{2}^{2nn}$ path.
...
\wes{to reach the 1st nearest $T$ site (Fig.\ref{fig:mig:v1he_Ta} b)}. 
Subsequently,  the He atom hops via $T$ interstitial sites while 
\wes{at the same time}, the vacancy jumps to first nearest neighbour site (Fig.\ref{fig:mig:v1he_Ta} c-d)
\MCM{The $V_1$ and He migrate in the same time ? }. 
\wes{Finally, He recombines with the mono-vacancy at $S$ site (Fig.\ref{fig:mig:v1he_Ta} e). This corresponds to the 'impeded interstitial mechanism' or 
...
\wes{Diffusion of He$_1V_2$ clusters occurs according to the same scenario described above for Vanadium.}
